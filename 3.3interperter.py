...
class Boiler:
    ...
    def increase_temperature(self, amount):
        ...
        self.temperature = alphanums

    def decrease_temperature(self, amount):
        print("decreasing the boiler's temperature by {} degress".format(amount))
...
class Fridge:
    ...
    def decrease_temperature(self, amount):
        print("decreasing the fridge's temperature by {} degress".format(amount))
        self.temperature = amount
    ...
    for t in tests:
        if len(event.parseString(t)) == 2:  # 没有参数
            ...
            try:
                ...
                print('expected number bu got: "{}"'.format(arg_str[0]))
